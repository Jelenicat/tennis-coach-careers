  ...
  return (
    <main className="legalPage">
      <div className="legalCard">
        ...
        <p>
          This Cookie Policy explains how Tennis Coach Careers uses cookies and
        ...
        <p>
          Some cookies are necessary for the platform to work properly, such as
        ...
        <p>
          ...
          However, some parts of the platform may not work correctly if cookies
          are disabled.
        </p>

        <h2>6. Contact</h2>
        <p>
          For questions about this Cookie Policy, please contact us through the
          Contact page.
        </p>
      </div>
    </main>
