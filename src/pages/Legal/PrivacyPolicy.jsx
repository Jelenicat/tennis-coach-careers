  ...
  return (
    <>
      <SEO
        ...
        description="Read the Tennis Coach Careers Privacy Policy and learn how personal data, profiles, uploaded content, job listings and applications are collected, used and protected."
        url="https://tennis-coach-careers.com/privacy"
      />
      ...
      <main className="legalPage">
        <div className="legalCard">
          ...
          <p>
            ...
            Firebase, including authentication, database and file storage
            services.
          </p>
          ...
          <h2>7. Security</h2>
          <p>
            We take reasonable steps to protect your data, but no online
