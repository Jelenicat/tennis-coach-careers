  ...
  return (
    <main className="legalPage">
      <div className="legalCard">
        ...
        <p>
          Welcome to Tennis Coach Careers. By using this platform, you agree to
          these Terms of Use.
        </p>

        <h2>1. Platform purpose</h2>
        <p>
          Tennis Coach Careers connects tennis coaches with academies, clubs and
          organizations looking for tennis professionals.
        </p>
        ...
        <p>
          Academies are responsible for the accuracy of job listings they post.
          Coaches are responsible for the accuracy of their profiles,
          qualifications, experience and uploaded content.
        </p>

        <h2>5. No employment guarantee</h2>
        <p>
          Tennis Coach Careers does not guarantee that coaches will receive job
          offers or that academies will find suitable candidates.
        </p>
